...
from Menu import MSmenu,MenuSystem
...
frame    = MSmenu(("red","blue","white","brown"),'frame')
alphabet = MSmenu("abcdefghijklmnopqrstuvwxyz",'alphabet')
color    = MSmenu(("sub0","sub1",frame),"color",(0,1))
main     = MSmenu(("main0",alphabet,color,"exit"),'')
